...
def Logistic_Regression(x_train, x_test, y_train, y_test):
    ...
    print('Logistic Regression: Accuracy: {:.2f}| Time: {:.2f} ms'.format(accuracy, (end - start)*1000))
...
def Logistic_Regression_CV(x, y):
    ...
    print("Cross-validation scores:", scores)
    print('Logistic Regression (CV): Accuracy: {:.2f}| Time: {:.2f} ms'.format(scores.mean(), (end - start) * 1000))
